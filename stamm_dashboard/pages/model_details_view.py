...
def generate_model_details_view(config):
    ...
    model_ident = config['ml_model_configuration']['model_identification']
    model_desc = config['ml_model_configuration']['model_description']
    model_pack = model_desc.get('packages', [])
    model_train = config['ml_model_configuration']['training_information']
